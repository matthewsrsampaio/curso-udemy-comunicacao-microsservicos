...
class UserService {
    ...
    async getAccessToken(req) {
        try {
            ...
            console.info(`Request to POST login with data ${JSON.stringify(req.body)} 
    ...
    async validateAccessTokenData(email, password) {
        if(!email || !password) {
            throw new UserException(httpStatus.UNAUTHORIZED, "Email and passport must be informed.");
        }
    }
