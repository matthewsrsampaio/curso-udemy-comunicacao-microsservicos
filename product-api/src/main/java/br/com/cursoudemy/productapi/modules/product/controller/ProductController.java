...
public class ProductController {
    ...
    public List<ProductResponse> findAByName(@PathVariable String name) {
    ...
    public List<ProductResponse> findABySupplierId(@PathVariable Integer supplierId) {
    ...
    @DeleteMapping("{id}")
    public SuccessResponse delete(@PathVariable Integer id) { return productService.delete(id); }
